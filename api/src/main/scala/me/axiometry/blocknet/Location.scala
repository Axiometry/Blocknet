...
object Location {
  ...
  case class Precise(x: Double, y: Double, z: Double) extends Conversions with ExactConversions {
  ...
  case class Block(x: Integer, y: Integer, z: Integer) extends Conversions with ExactConversions {
  ...
  case class Chunk(x: Integer, y: Integer, z: Integer) extends Conversions with ExactConversions {
